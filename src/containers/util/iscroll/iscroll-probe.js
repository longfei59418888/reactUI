  ...
  IScroll.prototype = {
    ...
    resetPosition(time) {
      ...
      if (!this.hasVerticalScroll || this.y > 0) {
        y = 0;
        if (this.y > this.options.refreshHeight-1 && this.options.hasRefresh) y = this.options.refreshHeight;
    ...
    _wheel(e) {
      ...
      let wheelDeltaX; let wheelDeltaY;
      let newX; let newY;
      const that = this;
    ...
    _key(e) {
      ...
      const { snap } = this.options;	// we are using this alot, better to cache it
